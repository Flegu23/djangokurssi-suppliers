...
from .views import productlistview, supplierlistview, addsupplier, addproduct, \
    deleteproduct, confirmdeleteproduct, edit_product_get, edit_product_post, searchsuppliers, \
        products_filtered, loginview, login_action, logout_action, carlistview, addcar, searchcars, shoplistview, addshop, searchshops
...
urlpatterns = [
    ...
    path('add-shop/', addshop),
    path('search-shops/', searchshops)
